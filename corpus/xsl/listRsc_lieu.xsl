...
<xsl:variable name="countResearchers"><xsl:value-of select="count(dc:contributor[@olac:code='researcher'])"/></xsl:variable>
 ...
 <!-- <div align="right">
    <a target="_blank" href="citation_corpus.php?lg={$lg}&amp;lieu={$lieu}&amp;chercheurs={$researchers}&amp;sponsor={$sponsor}" onClick="window.open(this.href,'popupLink','width=600,height=100,scrollbars=yes,resizable=yes',1).focus();return false"><b><img src="../../images/icones/citation.jpg" width="77" height="26" /></b></a>
</div>-->
	</xsl:template>	
