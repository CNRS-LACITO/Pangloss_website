...
<!-- InstanceEndEditable -->
   ...
   <div>&nbsp;</div>
    <div class="row text-left">    
     ...
     <div class="col-xs-12">
     <h1 align="center">Rechercher une ressource dans la collection</h1>
<p>&nbsp; </p>
           <p>
            <img src="../../images/images_pangloss/haut_parleur_s.png" width="20" height="22"> : Accès à l'<b>enregistrement</b>
            </p>
            <p>
      ...
      <p>&nbsp; </p>
		<?php
			...
			Xslt_moteur_de_recherche('fr', $keywords);
		?>
