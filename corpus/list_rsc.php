            ...
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#F8E2D3">
                    <h4 class="panel-title" align="center">
                        <a href="index.html"><b>Retour à la liste des corpus<br/> </b></a>
                    </h4>
                </div> 
            </div>
        </div>
...
$aff=str_replace("\'","'",$aff) ;
			 ...
			 if ($lg == "Futunien"){
					echo("<h2>Langue : <a href=\"../../ALC/Languages/East_Uvean_popup.htm\" target=\"_blank\" onClick=\"window.open(this.href,'popupLink','width=400,height=400,scrollbars=yes,resizable=yes',pop.focus(),1);return false\">".$aff."</a></h2>");
	 		}
			else if ($lg == "Kurde_central"){
					echo("<h2>Langue : <a href=\"../../ALC/Languages/Kurdish_popup.htm\" target=\"_blank\" onClick=\"window.open(this.href,'popupLink','width=400,height=400,scrollbars=yes,resizable=yes',pop.focus(),1);return false\">".$aff."</a></h2>");
	 		}
			else if ($lg == "Wallisien"){
				echo("<h2>Langue : <a href=\"../../ALC/Languages/East_Uvean_popup.htm\" target=\"_blank\" onClick=\"window.open(this.href,'popupLink','width=400,height=400,scrollbars=yes,resizable=yes',pop.focus(),1);return false\">".$aff."</a></h2>");
	 		}
		else {echo("<h2>Langue : ".$aff."</h2>");}
	 }
 ...
 <div class="table text-left">
  <table class="table-responsive" border="1">
 	<tr>
        ...
        <td>&nbsp;&nbsp;Accès à l'<b>enregistrement</b> </td>
    </tr>
    <tr>
		<td><img src="../../images/icones/Txt_Inter_parchemin.jpg" width="30" height="30"/></td>
        <td>&nbsp;&nbsp;Accès au <b>texte annoté synchronisé</b> avec l'enregistrement audio</td>
    </tr>
    <tr> 
		<td><img src="../../images/icones/pdf_son2.png" width="25" height="25"/></td>
        <td>&nbsp;&nbsp;Accès au <b>fichier PDF</b> accompagné de l'enregistrement audio </td>
    </tr>
    <tr> 
    ...
    echo "<a data-toggle=\"collapse\" href=\"#language\"><b>+ <b class=\"caret\"></b></b></a>";
    echo "</h4>";
    echo "</div>";
    echo "<div id=\"language\" class=\"panel-collapse collapse\">";
	...
	//echo "<div class=\"divider-vertical\"/>";
