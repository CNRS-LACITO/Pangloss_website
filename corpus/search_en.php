...
<title>Search in the Collection</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
                               ...
                               <li class="dropdown"></li>
                                <li class="dropdown"> 
                                   <a data-toggle="dropdown" href="#">Help<b class="caret"></b></a>
                                    ...
                                    <li> <a href="search_en.php">Search</a>
   ...
   <div class="row text-left">   
    ...
    <h1 align="center">Search for a resource in the Collection</h1>
           <p>&nbsp; </p>
           <p>
            <img src="../../images/images_pangloss/haut_parleur_s.png" width="20" height="22"> : Access to the <b>recording</b>
        </p>
            <p>
           <img src="../../images/icones/Txt_Inter_parchemin.jpg" width="30" height="30"> : Access to <b>synchronized and annotated text</b> 
           </p>
           <p>
           <img src="../../images/icones/info_33px.gif" width="25" height="25"> :  <b>Informations</b> about the resource (metadata)           
           </p>
           <p>&nbsp; </p>
           <p>&nbsp; </p>
           <p>&nbsp; </p>
      ...
      <p>&nbsp; </p>
          ...
          <?php
			...
			$keywords=  isset($_GET["keywords"])    ? utf8_encode($_GET["keywords"])    : "";
			Xslt_moteur_de_recherche('en', $keywords);
		?>
</div>
