...
?>" class="csstransforms csstransforms3d csstransitions"><!--<![endif]-->
    ...
    <head>
        ...
        <!--[if IE]>
            <link href="/wp-content/themes/SCRN/css/ie.css" rel='stylesheet' type='text/css'>
        <![endif]-->

        <meta name="language" content="<?php echo Yii::app()->language; ?>" />    
        <meta name="description" content="<?php echo Yii::t("projet", "Moonlight est un site internet multilingue, 
                accessible à tous et dédié à la langue taï blanc. Il a été construit à partir de 
             publications ethnolinguistiques, d'enquêtes de terrain auprès de locuteurs taï don
             et de documents manuscrits afin de proposer le contenu suivant:"); ?>" />
        <meta property="og:title" content="<?php echo CHtml::encode($this->pageTitle); ?>" />
        <meta property="og:description" content="<?php echo Yii::t("projet", "Moonlight est un site internet multilingue, 
                accessible à tous et dédié à la langue taï blanc. Il a été construit à partir de 
             publications ethnolinguistiques, d'enquêtes de terrain auprès de locuteurs taï don
             et de documents manuscrits afin de proposer le contenu suivant:"); ?>" />
        <meta property="og:image" content="<?php echo Yii::app()->baseUrl . '/images/carousel/slide1.jpg'; ?>" />
        ...
        <script type="text/javascript" src="<?php echo $baseUrl; ?>/custom-js/SCRN/jquery.js"></script>
        <script type="text/javascript" src="<?php echo $baseUrl; ?>/custom-js/SCRN/jquery-migrate.min.js"></script>
        <script type="text/javascript" src="<?php echo $baseUrl; ?>/custom-js/SCRN/jquery.cycle.all.min.js"></script>
        <script type="text/javascript" src="<?php echo $baseUrl; ?>/custom-js/SCRN/jquery.flexslider.js"></script>
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="/xmlrpc.php?rsd"> 
        <?php
        $js->registerCssFile($baseUrl . '/css/font.css');
        $js->registerScriptFile($baseUrl . '/custom-js/jquery-1.11.0.js');
        //$js->registerScriptFile('https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false');
        $js->registerScriptFile('http://maps.googleapis.com/maps/api/js?libraries=places&amp;sensor=false');
...
<div id="mainmenu" class="ui sidebar vertical menu">
    ...
    <a class="active teal item" href="<?php echo $this->createUrl('outils/manuscrit'); ?>">
