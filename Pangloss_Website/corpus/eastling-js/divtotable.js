...
(function ($) {
    ...
    header.append('<br>').append('Langue : ').append(link_langue).append('<br><br>').append(table_contributeurs);
    ...
    tbody_opt1.append('<tr><th>Transcription par phrase</th></tr>');
    ...
    tbody_opt1.append('<tr><th>Traduction par phrase</th></tr>');
    ...
    tbody_opt2.append('<tr><th>Transcription du texte complet</th></tr>');
    ...
    tbody_opt2.append('<tr><th>Traduction du texte complet</th></tr>');
    var tr_traduction = $('<tr></tr>');
    var td_traduction = $('<td></td>');
    ...
    var td_opt3 = $('<td></td>');
    td_opt3.append('<table><tbody><tr><th>Mot à mot</th><td><input checked="checked" name="interlinear" type="checkbox"></td></tr><tr><td><br></td></tr><tr><td><br></td></tr></tbody></table>');    
    ...
    $.each(opt_traductions,function(){
        ...
        var div_trans_text = $('<div style="display:none;" class="trad_text trad_text_'+this+'"></div>');
