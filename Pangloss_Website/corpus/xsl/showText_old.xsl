                                        				...
                                        				<xsl:choose>
																<xsl:when test="M/FORM">
																	<xsl:choose>
																		...
																		<xsl:choose>
                                                                             <xsl:when test="M/FORM[@xml:lang!='fr' and @xml:lang!='en' and @xml:lang!='it' and @xml:lang!='de' and @xml:lang!='cn' and @xml:lang!='vn' and @xml:lang!='zh']">
                                                                             
                                                                             <div class="m_form_other">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:for-each select="M/FORM[@xml:lang='en']">
                                                								<div class="m_form_en">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='fr']">
                                                								<div class="m_form_fr">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:for-each select="M/FORM[@xml:lang='fr']">
                                                								<div class="m_form_fr">
                                                                            		...
                                                                            		<xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='it']">
                                                								<div class="m_form_it">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='de']">
                                                								<div class="m_form_de">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='cn']">
                                                								<div class="m_form_cn">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='vn']">
                                                								<div class="m_form_vn">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
                                                                            ...
                                                                            <xsl:text> </xsl:text>
                                                                            <xsl:for-each select="M/FORM[@xml:lang='zh']">
                                                								<div class="m_form_zh">
																					 <xsl:value-of select="."/>
																					 <xsl:if test="position()!=last()">-</xsl:if>
                                                                                </div>
