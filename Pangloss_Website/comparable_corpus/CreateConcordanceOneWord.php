...
echo "<div class=\"row\">";
    echo "<div class=\"col-md-4\" align=\"right\">";
         echo "<div class=\"panel-group\">";      
            echo "<div class=\"panel panel-default\">";        
                echo "<div class=\"panel-heading\" style=\"background-color:#F8E2D3\">";
                    echo "<h4 class=\"panel-title\" align=\"center\">";
                        echo "<a href=\"selection.php\"><b>Comparer d'autres textes<br/> </b></a>";
                    echo "</h4>";
                echo "</div> ";
			echo " </div>";
        echo "</div>";
    ...
    echo "</div>";
	 ...
	 echo "<div class=\"col-md-4\" align=\"right\">";
         echo "<div class=\"panel-group\">";      
            echo "<div class=\"panel panel-default\">";        
                echo "<div class=\"panel-heading\" style=\"background-color:#E6E2FA\">";
                    echo "<h4 class=\"panel-title\" align=\"center\">";
                        echo "<a href=\"BackViewAllSimilarities_en.php?similarity=$filesim&amp;file1=$file1&amp;file2=$file2&amp;file3=$file3&amp;file4=$file4&amp;file5=$file5&amp;file6=$file6&amp;nbsim=$nbsim\"><b>Retour aux textes comparés<br/> </b></a>";
                    echo "</h4>";
                echo "</div> ";
			echo " </div>";
        echo "</div>";
	...
	echo "</div>";
	  ...
	  set_time_limit(0); 
		...
		CreateConcordanceOneWord($mot, $filesim, $file1, $file2, $file3, $file4, $file5, $file6, $nbsim);
	 


	 
function CreateConcordanceOneWord($mot, $filesim, $file1, $file2, $file3, $file4, $file5, $file6, $nbsim) {
