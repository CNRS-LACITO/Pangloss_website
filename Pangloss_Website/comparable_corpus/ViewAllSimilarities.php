...
if (isset($_POST['leper'])) {
	$similarity="leper.xml";
	 $i=0;
foreach($_POST['leper'] as $valeur)
{
   $file[$i]=$valeur;
   $i++;
}
...
if (isset($_POST['GhumnePani'])) {
	$similarity="GhumnePani.xml";
	 $i=0;
foreach($_POST['GhumnePani'] as $valeur)
{
   $file[$i]=$valeur;
   $i++;
}
