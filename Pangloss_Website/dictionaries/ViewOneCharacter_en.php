    ...
    <body>
            ...
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#EBDEED">
                    <h5 class="panel-title" align="center">
                        <a href="ViewOneCharacter.php?sortorder=sort_order_inv.xml&alphabet=dev&dict=khaling&lang1=eng&lang2=*&langn=*&char=अ"><b>View Devanagari version<br/> </b></a>
                    </h5>
                </div> 
            </div>
        </div>
        ...
        <?php
            ...
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#EBDEED">
                    <h5 class="panel-title" align="center">
                        <a href="ViewOneCharacter.php?sortorder=sort_order.xml&alphabet=ipa&dict=khaling&lang1=eng&lang2=*&langn=*&char=ʔ"><b>View IPA version<br/> </b></a>
                    </h5>
                </div> 
            </div>
        </div>
