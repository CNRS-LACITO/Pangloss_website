...
<xsl:stylesheet 
	...
	<xsl:template match="/">
    <xsl:variable name="id_tot">oai:crdo.vjf.cnrs.fr:<xsl:value-of select="$id"></xsl:value-of></xsl:variable>
    <xsl:variable name="id_xml" select="//oai:ListRecords/oai:record[oai:header/oai:identifier = $id_tot]/oai:metadata/olac:olac/dcterms:isRequiredBy"></xsl:variable>
  <!--<xsl:for-each select=".//oai:record/oai:metadata/olac:olac[dc:subject=$lg][contains(dcterms:spatial,$lieu)][dc:type='Sound' or dc:type='MovingImage'][not(dcterms:accessRights='Access restricted (password protected)')]">-->
    <result>
    <file_audio><xsl:value-of select="//oai:ListRecords/oai:record[oai:header/oai:identifier = $id_tot]/oai:metadata/olac:olac/dc:identifier"/></file_audio>
    <file_xml><xsl:value-of select="//oai:ListRecords/oai:record[oai:header/oai:identifier = $id_xml]/oai:metadata/olac:olac/dc:identifier"/></file_xml>
  </result>
