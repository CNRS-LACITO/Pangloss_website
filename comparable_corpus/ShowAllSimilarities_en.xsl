    ...
    <xsl:template match="/">
       ...
       <br/>
        ...
        <div class="table-responsive row">
            ...
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#F8E2D3">
                    <h4 class="panel-title" align="center">
                        <a href="selection.php"><b>Compare other texts<br/> </b></a>
                    </h4>
                </div> 
            </div>
        </div>
            ...
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#e5eecc">
                    <h4 class="panel-title" align="center">
                        <a href="#"><b>Concordances (on gloss or morphems) </b></a> <a href="#" onClick="window.open('info_concordance.html','popupLink','toolbar=no,status=no,width=700px ,height=50px,resizable=yes',1).focus();return false">
		...
		<xsl:if test="contains($filesim, 'orphans')='true'">
        	<p>
            <br/>
            <h3 align="center"><u>Proto-story Orphans</u></h3>
            <br/>
        </p>
        </xsl:if>
        <xsl:if test="contains($filesim, 'ogress')='true'">
           <p>
            <br/>
            <h3 align="center">Proto-story Ogress</h3>
            <br/>
        </p>
        </xsl:if>
        <xsl:if test="contains($filesim, 'urmother')='true'">
        	<p>
            <br/>
            <h3 align="center">Proto-story Ur-Mother</h3>
            <br/>
        </p>
        </xsl:if>
         <xsl:if test="contains($filesim, 'leper')='true'">
        	<p>
            <br/>
            <h3 align="center">Proto-story Leper</h3>
            <br/>
        </p>
        </xsl:if>
        <xsl:if test="contains($filesim, 'GhumnePani')='true'">
        	<p>
            <br/>
            <h3 align="center">Proto-story Ghumne Pani</h3>
            <br/>
        </p>
        </xsl:if>
...
<p><b>Event <xsl:value-of select="$num_sim"/></b><br/></p>
                                    ...
                                    <a
                                        ...
                                        <p><b>Event <xsl:value-of select="$num_sim"
                                            /></b><br/></p>
