    ...
    <!--<xsl:value-of select="$filesim"/>-->
        ...
        <xsl:if test="contains($filesim, 'urmother')='true'">
           <h4 align="center">Proto-story Ur-Mother</h4>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file1]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file1]/@speaker"/>
           			</xsl:call-template>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file2]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file2]/@speaker"/>
           			</xsl:call-template>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file3]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file3]/@speaker"/>
           			</xsl:call-template>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file4]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file4]/@speaker"/>
           			</xsl:call-template>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file5]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file5]/@speaker"/>
           			</xsl:call-template>
                ...
                <xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file6]">
                    	...
                    	<xsl:with-param name="speaker" select="document($filesim)//similarities/files/file[@id=$file6]/@speaker"/>
           			</xsl:call-template>
      ...
      <xsl:template name="onesim">
                                ...
                                <td>
									...
									<tr><th align="left" bgcolor="#CCCCCC" style="font-size:18px"> <xsl:value-of select="$lang"/> (<xsl:value-of select="$speaker"/>)</th></tr></table>
                                </td>
                                </tr>
								...
								<xsl:variable name="id_s" select="@id" />
									...
									<xsl:if test="document($filesim)//similarities/similarity[@id=$nsim]/file[@id=$file]/sentence[@id=$id_s]">
										...
										<td class="segmentContent" width="600px" bgcolor="{$color}">
											...
											<b><span>S<xsl:value-of select="$num_s"/></span></b>
											...
											<xsl:if test="(W/M/FORM and W/M/TRANSL) or (W/FORM and W/TRANSL) ">
