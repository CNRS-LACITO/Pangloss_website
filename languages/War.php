...
<p class="intertitre">&nbsp;</p>
     ...
     <p class="intertitre">&nbsp;</p>
            ...
            <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA020_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Récit du Bahilom</a></p>
     <p class="intertitre">
...
<p class="intertitre">&nbsp;</p>
<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA018_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0">Musique mɛrkeːu (jewish harp en bambou) et Chants traditionnels loŋ haj de récoltes de millet</a><br/>
...
<p>
 Un homme nommé sieur Rendi pêche un gros poisson. Rentré chez lui il ne le mange pas mais le laisse sécher au dessus de sa cheminée. Quand il revient chez lui de ses champs la maison est rangée et le dîner est servi. Au bout d'un certain temps, il se cache pour savoir qui accomplit ceci. Il découvre une merveilleuse jeune femme chez lui et la peau vide du poisson à sa place, au dessus de la cheminée pour sécher. Il entre précipitamment, brûle la peau. Il épouse la jeune femme qui enfante les gens qui sont les wars et les pnars perpétuant les semences de l'ancêtre clanique qu'elle incarne (voir les explication de Kundep Sumer de Nongbareh). Elle lui précise que la pureté d'une propreté absolue devra régner dans la maison. Un jour la mère de sieur Rendi oublie le balai à l'intérieur du foyer. Elle s'enfuit et retourne vivre dans la rivière clanique des wars et des pnars. Selon les lieux où cette histoire est racontée, le nom de la rivière clanique est utilisé.
  ...
  <p class="intertitre"></p>
  <p class="intertitre">&nbsp;</p>
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA011_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Conte traditionnel du chevreuil, des patates douces et du tigre</a></p>
  ...
  <p class="intertitre">&nbsp;</p>
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA012_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Conte traditionnel : Bal avec les ancêtres à l'intérieur du ciel</a></p>
  ...
  <p class="intertitre">&nbsp;</p>
  <p class="intertitre">&nbsp;</p>
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA017_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Explications sur le mariage clanique et les augures donnés par les ancêtres selon le rituel de divination de l'œuf</a></p>
  ...
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA010_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Khrishno et Rondika</a></p>
  ...
  <p class="intertitre">&nbsp;</p>
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA013_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Récit traditionnel : Suɲ, Irmaj, Hɛrmɔn, les trois soeurs ancêtres</a></p>
  <p class="intertitre"> Kudeng Thymmai, Meghalaya, Inde, 2006, Thakur Pohtam Teang, <a href="../../membres/daladier.htm">Anne Daladier</a></p>
  ...
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA005_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Opposition phonologique tʃɔ ! (interjection) / tʒi 'riz'</a></p>
     <p class="intertitre">
      Kudeng Thymmai, Meghalaya, Inde, 2006, Lakhmie Pohtam Sohsley, <a href="../../membres/daladier.htm">Anne Daladier</a></p>
        ...
        <p>Opposition phonologique tʃɔ ! (interjection) / tʒi 'riz'    où /tʒ/  est en fait un dévoisement de /ɟ/ différent de /tʃ/. </p>
         <p class="intertitre">&nbsp;</p>
         <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA007_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Liste lexicale illustrant l'opposition : / tʒ /  /tʃ/ </a></p>
     <p class="intertitre">
       ...
       <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA046_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0">Klao Bemon </a><br/>
...
Le parler de Nongbareh et Lamin est plus innovateur que les autres parlers wars phonétiquement (nasalisations, transformation de voyelles finales en diphtongues, suppession de presyllabes) ; cela va dans le même sens que mes notes grammaticales sur ce dialecte. Cependant cette nasalisation est moins marquée chez les grands conteurs  (comme dans ce conte de Larsendriang).
 ...
 <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA050_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Explications sur le peuplement et les alliances des clans pnars et wars ; rituel à l'ancêtre des rivières pour avoir la pluie </a><br/>
...
<li><b>e) Korila. </b><br/>
Version courte du conte au sujet de cette fille de liʔ doʔ kha à comparer avec la version de woh Thakur et woh Monti à Kudeng.</b></li>
</ul>
 ...
 <p class="intertitre">&nbsp;</p>
    ...
    Lamin,  Meghalaya, Inde, 2009, clans participants à la cérémonie funéraire secondaire d'une maisonnée Pohlong,  <a href="../../membres/daladier.htm">Anne Daladier</a></p>
         <p>
         <ul>
<li><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA051_SOUND"> <img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"></a> 1) conte  parlé-chanté de Ancêtre Pohlong pendant la veillée qui précède la réunification des os dans le caveau Pohlong à Lamin. Le conducteur est Riang Phung. </li>
<li><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA052_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"></a> 2) Prières dans la maison et sur sa plateforme après avoir réuni les os du disparu avec ceux de l'ancêtre. Le conducteur est woh Tynrui</li>
         </ul>
</p>
 ...
 <p class="intertitre"><b>Cérémonie funéraire secondaire pour la femme de woh Tynrui</b><br/>
   Lamin,  Meghalaya, Inde, 2013, clans participants à la cérémonie funéraire secondaire,  <a href="../../membres/daladier.htm">Anne Daladier</a></p>
         <p>
         <ul>
         <li> <a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA053_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"></a> 1) et <a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA054_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"></a> 2)  Récit parlé chanté pendant la nuit avant la réunification des os.   Le conducteur est Tyiu Lamin Roh
Ce récit parle des ancêtres Min et Tam (des clans Lamin et Pohtam), des ancêtres  et des traditions. </li>
<li> <a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA055_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"></a> 3) prières dans la maison après la réunification des os</li>
</ul>
(voir photos du rituel)
 ...
 <p align="center">&nbsp;</p>
  ...
  <p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA026_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Rituel de séparation après la mort d'un conjoint pour le survivant (1)</a></p>
     ...
     <p class="intertitre">
        ...
        <h4 id="war_nongtalang">2.d. War de Nongtalang            </h4>
        	...
        	<p class="intertitre">&nbsp;</p>
              ...
              <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA056_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Chants et récits traditionnels de récolte (pawar loŋ haj)</a><br/>
   ...
   <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA057_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Récit traditionnel sur la création du monde </a><br/>
     ...
     <p class="intertitre">
        ...
        <p>A comparer avec les chants de loŋ haj enregistrés en war amwi à Thangbuli  en 2003 de woh De    et avec ceux de Nongtalang, 2009, de Woh Akyi Myrsiang. Tous ces chants traditionnels de fertilité ont des emprunts pnars ou sont directement d'origine pnar comme : musʔjaŋ 'pierre des semences', l'Ancêtre de la terre fertile, célébrée par les pnars et les wars </p>
            ...
            <p class="intertitre">&nbsp;</p>
              ...
              <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA044_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Récit: comment les gens de Padu ont décidé de faire alliance avec ceux de Nongtalang et d'avoir le même roi. Mawngap est proche de Padu où se sont associés des clans amwi et des clans de Nongtalang. </a></p>
  War de Mawngap, Meghalaya, Inde, 2009, Woh Oni,  <a href="../../membres/daladier.htm">Anne Daladier</a></p>
   ...
   <p class="intertitre">&nbsp;</p>
     ...
     <h4 id="war_mawngap">3.a. War du district  de Syndai</h4>
      ...
      <p class="intertitre">&nbsp;</p>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA042_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Description d'une grande grotte, peuplée de chauve-souris</a></p>
...
<h4 id="war_mawngap">3.b. War de Kwator et Satpator</h4>
		<p class="intertitre"><a href="http://lacito.vjf.cnrs.fr/pangloss/corpus/show_text.php?id=crdo-AML_ADA043_SOUND"><img src="../../images/images_pangloss/haut_parleur_s.png" alt="a" width="20" height="20" border="0"> Vocabulaire des villages de Pesatwar  et de  Kwator et phrases comparées  dans les dialectes wars : Kwator, Pesatwar et Kudeng .</a></p>
