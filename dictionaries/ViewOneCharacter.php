...
<script type="text/javascript" src="../bootstrap-3.3.6-dist/js/jquery.js"></script>
...
<!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div  id="top" class="row total">
                            ...
                            <ul class="nav navbar-nav" id="menu">
                                ...
                                <li class="dropdown"> 
                                    ...
                                    <ul class="dropdown-menu jqueryFadeIn">
                                        ...
                                        <li><a href="limbu/index.html">Limbu</a></li>
                                    </ul>
                                </li>      
        	...
        	ViewAlphabet($alphabet, $sortorder, $dict, $lang1, $lang2, $langn);

    	    function ViewAlphabet($alphabet, $sortorder, $dict, $lang1, $lang2, $langn) {
       		    $xp = new XsltProcessor();
        	    $xsl = new DomDocument;

        	    $xsl->load('ShowAlphabetMenu.xsl');
				$xp->setParameter('', 'alphabet', $alphabet);
				$xp->setParameter('', 'sortorder', $sortorder);
        ...
        ?>
			...
			if ($dict=="khaling" and $alphabet=="ipa"){
				?> 
                <div class="row">
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2" align="right">
               
                 <div class="panel-group">      
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#EBDEED">
                    <h5 class="panel-title" align="center">
                        <a href="ViewOneCharacter.php?sortorder=sort_order_inv.xml&alphabet=dev&dict=khaling&lang1=eng&lang2=*&langn=*&char=अ"><b>Voir la version en dévanagari<br/> </b></a>
                    </h5>
                </div> 
            </div>
        </div>
        ...
        <?php
			...
			if ($dict=="khaling" and $alphabet=="dev"){
				?>
                <div class="row">
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2" align="right">
                 <div class="panel-group">      
            <div class="panel panel-default">        
                <div class="panel-heading" style="background-color:#EBDEED">
                    <h5 class="panel-title" align="center">
                        <a href="ViewOneCharacter.php?sortorder=sort_order.xml&alphabet=ipa&dict=khaling&lang1=eng&lang2=*&langn=*&char=ʔ"><b>Voir la version en API<br/> </b></a>
                    </h5>
                </div> 
            </div>
        </div>
        ...
        <?php
			...
			if ($alphabet=="dev"){
				ViewEntriesDev($alphabet, $dict, $lang1, $lang2, $langn, $char);
			}
            else{	ViewEntries($alphabet, $sortorder, $dict, $lang1, $lang2, $langn, $char);
			}
    
            	function ViewEntries($alphabet, $sortorder, $dict, $lang1, $lang2, $langn, $char) {
            		$xp = new XsltProcessor();
                	$xsl = new DomDocument;
				...
				function ViewEntriesDev($alphabet, $dict, $lang1, $lang2, $langn, $char) {
            		$xp = new XsltProcessor();
                	$xsl = new DomDocument;
    
            		$xsl->load('ShowOneCharacterDev.xsl');
