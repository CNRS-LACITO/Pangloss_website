from DOI_stage.DoiPangloss.objects.Record import Record
from DOI_stage.DoiPangloss.constantes import NAMESPACES, SHOW_TEXT, IDREF, EASTLING_PLAYER, SHOW_OTHER, CRITICAL_LOG
import re
import logging
import csv
import os
...
def parserRecord (record):
        ...
        """
        if record.find('*/oai:identifier', NAMESPACES). text == "oai:crdo.vjf.cnrs.fr:crdo-dtd_archive":
            return None
        else:
            doiIdentifiant = ""
